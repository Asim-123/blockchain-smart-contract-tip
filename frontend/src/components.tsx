...
import { TIP_JAR_ABI, CONTRACT_ADDRESS, BACKEND_URL } from "./config";
    ...
    <div className="card">
      <div className="card-header">
        <div>
          ...
          <p className="card-subtitle">Attach a message and send ETH on-chain</p>
        </div>
      </div>
